...
## Heads up
This project is in constant iteration. Mainly for the CVZone-Python side. Latest iteration includes a gesture rule classifier that switches from one text-prompt to another inside TD. (TouchDesigner file update not included)
